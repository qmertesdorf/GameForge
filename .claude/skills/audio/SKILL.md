...
## 3. Author recipes
One recipe per SFX + one music recipe. Each prompt = `mood_prompt` + the clip-specific description. Defaults confirmed at the audio feasibility gate:
...
**Reference settings (owner-confirmed by ear):**
