...
The audit extends to the **composited render**, not just the raw PNG — when code draws chrome over the art, eyeball the assembled widget for layout collisions/clipping too (see the visual-audit skill). "The art is good" ≠ "the screen is good."
